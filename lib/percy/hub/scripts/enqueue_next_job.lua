...
-- If there are no idle workers available, we cannot queue the job. We compute the number of idle
...
num_idle_workers = num_idle_workers - num_jobs_runnable

if num_idle_workers == 0 then
